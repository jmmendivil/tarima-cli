...
module.exports = function(options, done) {
  ...
  ['src', 'dest', 'cache', 'cacheFile'].forEach(function(subpath) {
    if (options[subpath]) {
  ...
  options.bundleOptions = options.bundleOptions || { globals: {} };
  ...
  // vendors
  if ($.resolve('main-bower-files', false)) {
    require('./bower-files').call(context);
  }

  // support for imageTag()
  if ($.resolve('fast-image-size', false)) {
    require('./fast-images/helper').call(context);
  }
